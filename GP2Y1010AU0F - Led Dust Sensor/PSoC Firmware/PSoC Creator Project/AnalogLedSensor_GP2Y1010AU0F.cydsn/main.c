...
int main()
{
    ...
    for(;;)
    {
        ...
        advPayload[19] =  0x03; //Sensor ID: 0x03 for GP2Y1010AU0F
        advPayload[21] =  val>>8; //High byte of sensor measurement
        advPayload[22] =  val&0xFF; //Low byte of sensor measurement
